...
public class PrintfFormat
{
	...
	private class ConversionSpecification
	{
		...
		/**
		 * For f format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. '+' character means that the conversion will always begin with a sign (+ or -). The blank flag character means that a non-negative input
		...
		/**
		 * For e format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. '+' character means that the conversion will always begin with a sign (+ or -). The blank flag character means that a non-negative input
		 * will be preceded with a blank. If both a '+' and a ' ' are specified, the blank flag is ignored. The '0' flag character implies that padding to the field width will be done with zeros instead of blanks. The field width is treated as the minimum number of characters to be printed. The
		...
		/**
		 * Format method for the g conversion character. For g format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. '+' character means that the conversion will always begin with a sign (+ or -). The blank
		...
		/**
		 * Format method for the d conversion specifer and short argument. For d format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. A '+' character means that the conversion will always begin with a sign (+
		...
		/**
		 * Format method for the d conversion character and long argument. For d format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. A '+' character means that the conversion will always begin with a sign (+
		 * or -). The blank flag character means that a non-negative input will be preceded with a blank. If both a '+' and a ' ' are specified, the blank flag is ignored. The '0' flag character implies that padding to the field width will be done with zeros instead of blanks. The field width is
		 * treated as the minimum number of characters to be printed. The default is to add no padding. Padding is with blanks by default. The precision, if set, is the minimum number of digits to appear. Padding is with leading 0s.
		 * @param x the long to format.
		 * @return the formatted String.
		...
		/**
		 * Format method for the d conversion character and int argument. For d format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. A '+' character means that the conversion will always begin with a sign (+
		 * or -). The blank flag character means that a non-negative input will be preceded with a blank. If both a '+' and a ' ' are specified, the blank flag is ignored. The '0' flag character implies that padding to the field width will be done with zeros instead of blanks. The field width is
		 * treated as the minimum number of characters to be printed. The default is to add no padding. Padding is with blanks by default. The precision, if set, is the minimum number of digits to appear. Padding is with leading 0s.
		 * @param x the int to format.
		 * @return the formatted String.
		...
		/**
		 * Format method for the x conversion character and short argument. For x format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The '#' flag character means to lead with '0x'. The field width is
		 * treated as the minimum number of characters to be printed. The default is to add no padding. Padding is with blanks by default. The precision, if set, is the minimum number of digits to appear. Padding is with leading 0s.
		 * @param x the short to format.
		 * @return the formatted String.
		 */
		...
		/**
		 * Format method for the x conversion character and long argument. For x format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The '#' flag character means to lead with '0x'. The field width is treated
		...
		/**
		 * Format method for the x conversion character and int argument. For x format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The '#' flag character means to lead with '0x'. The field width is treated
		 * as the minimum number of characters to be printed. The default is to add no padding. Padding is with blanks by default. The precision, if set, is the minimum number of digits to appear. Padding is with leading 0s.
		 * @param x the int to format.
		 * @return the formatted String.
		 */
		...
		/**
		 * Format method for the o conversion character and short argument. For o format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The '#' flag character means that the output begins with a leading 0 and
		...
		/**
		 * Format method for the o conversion character and long argument. For o format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The '#' flag character means that the output begins with a leading 0 and
		 * the precision is increased by 1. The field width is treated as the minimum number of characters to be printed. The default is to add no padding. Padding is with blanks by default. The precision, if set, is the minimum number of digits to appear. Padding is with leading 0s.
		 * @param x the long to format.
		 * @return the formatted String.
		 */
		...
		/**
		 * Format method for the o conversion character and int argument. For o format, the flag character '-', means that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The '#' flag character means that the output begins with a leading 0 and
		 * the precision is increased by 1. The field width is treated as the minimum number of characters to be printed. The default is to add no padding. Padding is with blanks by default. The precision, if set, is the minimum number of digits to appear. Padding is with leading 0s.
		 * @param x the int to format.
		 * @return the formatted String.
		 */
		...
		/**
		 * Format method for the c conversion character and char argument. The only flag character that affects c format is the '-', meaning that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The field width is treated as the minimum number of
		...
		/**
		 * Format method for the s conversion character and String argument. The only flag character that affects s format is the '-', meaning that the output should be left justified within the field. The default is to pad with blanks on the lel2f. The field width is treated as the minimum number
