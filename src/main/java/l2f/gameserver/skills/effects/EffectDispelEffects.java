...
public class EffectDispelEffects extends Effect
{
	...
	public void onStart()
	{
		...
		int currentCancelChance = (calcEachChance ? 100 : cancelRate); // Synerge - Now the first buff has 100% of chances
		...
		for (Effect effect : effectList)
		{
			...
			// Synerge - For each buff we reduce the chances by 15%, starting from 100%
