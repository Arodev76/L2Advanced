...
cls
echo Welcome to script setup for L2Advanced Server.
...
echo  - MySQL...       ok
echo ======================================================================
echo FandC Server is ready for installation.
...
echo #                         our L2Advanced product.                    #
echo #            Visit us on : http://l2advanced-project.forumeiros.com  #
echo ======================================================================
pause > nul